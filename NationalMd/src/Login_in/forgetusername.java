...
public class forgetusername extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Retrieve Username");
    ...
    private void SubmitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SubmitMouseClicked
        try {
            con = (Connection) Connective.getConnection();
            sql = "select *  from User_Details where User_email= ? and User_phone=?";
            pst = con.prepareStatement(sql);
            pst.setString(1, jTYourYN.getText());
            pst.setString(2, jTYourPN.getText());
            rs = pst.executeQuery();
            if (jTYourYN.getText().length() == 0) {
                JOptionPane.showMessageDialog(this, "Empty Email", "Warning", JOptionPane.WARNING_MESSAGE);
                ...
                String YSN = "Your Username is " + rs.getString("User_name");
                jPanel2.setVisible(true);
                J1.setText(YSN);
                final String User=rs.getString("User_name");
